package com.windman.hellocustomview.blogs.ZhangHongYang.sticky_recyerview;
...
public class PerformerListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 10) {
            return new ContentVH(LayoutInflater.from(mContext).inflate(R.layout.adapter_sticky_content, parent, false));
        }

        return new TitleVH(LayoutInflater.from(mContext).inflate(R.layout.adapter_sticky_title, parent, false));
    }
